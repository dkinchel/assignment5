...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
  ...
  /** Receives element and search counter then returns true if the element is in the tree */
  ...
  public TreeNode getRoot() {
    ...
    public ArrayList<E> path(E e)
    {
        ...
        while (current != null) 
        {
            ...
            {    
                //System.out.println("Path to element " + e + " = " + list.toString());
    ...
    public ArrayList<E> leftPath(TreeNode<E> root, E e, ArrayList<E> list)
    {
        return list;
    }
   
    /** Preorder traversal from a subtree */
  public ArrayList<E> subTreePreorder(TreeNode<E> root, ArrayList<E> list) 
  {
    if (root == null) return list;
    list.add(root.element);
    subTreePreorder(root.left, list);
    subTreePreorder(root.right, list);
    return list;
    ...
    public ArrayList<E> leftSubTree(E e, ArrayList<E> list){
    //left for you to implement in Lab 7
    TreeNode<E> current = root; // Start from the root
    while (current != null) {
      if (e.compareTo(current.element) < 0) {
      ...
      else // element matches current.element
      {
          ...
          {
              current = current.left;
              list = subTreePreorder(current, list);
          }
          return list;
      }
    }
    ...
    public ArrayList<E> rightSubTree(E e, ArrayList<E> list){
    //left for you to implement in Lab 7
    TreeNode<E> current = root; // Start from the root
    while (current != null) {
      if (e.compareTo(current.element) < 0) {
  ...
  public boolean sameTree(TreeNode<E> root, TreeNode<E> root2)
  {
      if(root == null && root2 == null) return true;
          if(root.element != root2.element) return false;
